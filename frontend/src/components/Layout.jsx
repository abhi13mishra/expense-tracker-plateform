...
import { ArrowDown, ArrowUp, Car, ChevronUp, ChevronDown, Clock, CreditCard, DollarSign, Gift, Home, Info, PieChart, PiggyBank, RefreshCw, ShoppingCart, Utensils, Zap } from 'lucide-react';
...
const Layout = ({ onLogout, user }) => {
  ...
  //to fetch transaction coming from server
      ...
      <div className={styles.layout.mainContainer(sideBarCollapsed)}>
        ...
        <div className={styles.statCards.grid}>
          ...
          <div className={styles.statCards.card}>
            ...
            <p className={styles.statCards.cardFooter}>
              <span className='text-green-600 font-medium'>+12.5%</span> from this month
            </p>
          </div>
          ...
          <div className={styles.statCards.card}>
            ...
            <p className={styles.statCards.cardFooter}>{getSavingsRating(stats.savingsRate)}</p>
          </div>
        </div>
              ...
              <div className={styles.transactions.listContainer}>
                ...
                {transactions.length === 0 ? (
                  <div className={styles.transactions.emptyState}>
                    ...
                    <p className={styles.transactions.emptyState}>
                      No transactions
                    </p>
                  </div>
