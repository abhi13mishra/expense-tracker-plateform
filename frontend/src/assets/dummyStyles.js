...
export const expensePageStyles = {
  ...
  addButton: "mt-3 md:mt-4 flex items-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white px-4 py-3 mx-auto rounded-xl transition-all shadow-md hover:shadow-lg font-medium",
