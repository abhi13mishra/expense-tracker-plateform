...
const Dashboard = () => {
  ...
  //update the gauge when time frame changed
  useEffect(() => {
    const maxValues = {
  ...
  //build server-providedn recent list
    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        <FinancialCard
          ...
          label="Total Balance"
          value={`$${Math.fround(displayIncome - displayExpenses).toLocaleString()}`}
          additionalContent={
        ...
        <FinancialCard
          ...
          additionalContent={
            <div className={`flex items-center gap-1 mt-2 text-xm ${expenseChange >= 0 ? trendStyles.positive : trendStyles.negative
              }`}>
              {expenseChange >= 0 ? (
        ...
        <FinancialCard
          ...
          additionalContent={
            <div className='flex items-center gap-2 mt-2 text-xm text-cyan-600'>
